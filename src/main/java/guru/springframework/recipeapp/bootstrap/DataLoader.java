...
//	private void guacamoleInitialization() {
//		UnitOfMeasure tablespoon = unitOfMeasureRepository.findByDescription("Tablespoon").get();
//
//		Recipe guacomole = new Recipe();
//
//		Set<Ingredient> ingredientSetForGuacamole = new HashSet<>();
...
//		notesGuacamole.setRecipeNotes("Chilling tomatoes hurts their flavor, so if you want to add chopped tomato to your guacamole, add it just before serving.");
//		notesGuacamole.setRecipe(guacomole);
//
//		Ingredient avocado = new Ingredient();
//		avocado.setDescription("Avocado");
//		avocado.setAmount(new BigDecimal(2));
//		avocado.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(avocado);
//
...
//		kosherSalt.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(kosherSalt);
//
...
//		juice.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(juice);
//
...
//		onion.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(onion);
//
...
//		chiles.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(chiles);
//
...
//		cilantro.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(cilantro);
//
...
//		pepper.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(pepper);
//
//		Ingredient tomato = new Ingredient();
//		tomato.setDescription("ripe tomato, seeds and pulp removed, chopped");
//		tomato.setAmount(new BigDecimal(0.5));
//		tomato.setRecipe(guacomole);
//
//		ingredientSetForGuacamole.add(tomato);
//
//		guacomole.setDescription("Guacamole, a dip made from avocados, is originally from Mexico. The name is derived from two Aztec Nahuatl words—ahuacatl (avocado) and molli (sauce).");
//		guacomole.setPrepTime(10);
//		guacomole.setCookTime(0);
//		guacomole.setServings(4);
//		guacomole.setSource("source");
//		guacomole.setUrl("https://www.simplyrecipes.com/recipes/perfect_guacamole/");
//		guacomole.setDirections("Avocado directions.");
//		guacomole.setIngredients(ingredientSetForGuacamole);
//		guacomole.setDifficulty(Difficulty.EASY);
//		guacomole.setNotes(notesGuacamole);
//		guacomole.setCategories(guacamoleCategories);
//
//		recipeRepository.save(guacomole);
//	}
	...
	private List<Recipe> getRecipes() {
		...
		guacRecipe.addIngredient(new Ingredient("serrano chillies", new BigDecimal(2), eachUom));
